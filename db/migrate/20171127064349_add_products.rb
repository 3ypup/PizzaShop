class AddProducts < ActiveRecord::Migration[5.1]
  def change
 	...
 	Product.create 	:title => "Pepperoni", 	:descrtiption => "This is Pepperoni Pizza!!", :price => 450, :size => 35, :is_spicy => true, :is_veg => false, :is_best_offer => false, :path_to_photo => "/images/pizza2.jpg"
